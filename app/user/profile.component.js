...
var UserProfileComponent = (function () {
    ...
    UserProfileComponent.prototype.ngOnInit = function () {
        var firstName = new forms_1.FormControl(this.authService.currentUser.firstName, [forms_1.Validators.required, forms_1.Validators.pattern('[a-zA-Z].*')]);
        var lastName = new forms_1.FormControl(this.authService.currentUser.lastName, forms_1.Validators.required);
        this.profileForm = new forms_1.FormGroup({
            firstName: firstName,
            lastName: lastName
        });
    };
    UserProfileComponent.prototype.handleCancelClick = function () {
...
UserProfileComponent = __decorate([
    ...
    __metadata("design:paramtypes", [auth_service_1.AuthService, router_1.Router, toastr_service_1.ToastrService])
