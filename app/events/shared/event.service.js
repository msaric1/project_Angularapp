...
var EventService = (function () {
    ...
    EventService.prototype.saveEvent = function (name, date, time, price, location, onlineUrl, imageUrl) {
        var newEvent = {
    ...
    EventService.prototype.updateEvent = function (event) {
        ...
        var idx = this.getEvent(event.id).id;
        EVENTS[idx] = event;
    };
    EventService.prototype.searchSessions = function (searchTerm) {
        ...
        var sendResult = new core_1.EventEmitter(true);
        setTimeout(function () {
